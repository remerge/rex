...
func RegisterRuntimeMemStats(r metrics.Registry) {
	...
	r.Register("go.runtime mem_stat_debug_gc", runtimeMetrics.MemStats.DebugGC)
	r.Register("go.runtime mem_stat_enable_gc", runtimeMetrics.MemStats.EnableGC)
	r.Register("go.runtime mem_stat_frees", runtimeMetrics.MemStats.Frees)
	r.Register("go.runtime mem_stat_heap_alloc", runtimeMetrics.MemStats.HeapAlloc)
	r.Register("go.runtime mem_stat_heap_idle", runtimeMetrics.MemStats.HeapIdle)
	r.Register("go.runtime mem_stat_heap_inuse", runtimeMetrics.MemStats.HeapInuse)
	r.Register("go.runtime mem_stat_heap_objects", runtimeMetrics.MemStats.HeapObjects)
	r.Register("go.runtime mem_stat_heap_released", runtimeMetrics.MemStats.HeapReleased)
	r.Register("go.runtime mem_stat_heap_sys", runtimeMetrics.MemStats.HeapSys)
	r.Register("go.runtime mem_stat_last_gc", runtimeMetrics.MemStats.LastGC)
	r.Register("go.runtime mem_stat_lookups", runtimeMetrics.MemStats.Lookups)
	r.Register("go.runtime mem_stat_m_allocs", runtimeMetrics.MemStats.Mallocs)
	r.Register("go.runtime mem_stat_m_cache_inuse", runtimeMetrics.MemStats.MCacheInuse)
	r.Register("go.runtime mem_stat_m_cache_sys", runtimeMetrics.MemStats.MCacheSys)
	r.Register("go.runtime mem_stat_m_span_inuse", runtimeMetrics.MemStats.MSpanInuse)
	r.Register("go.runtime mem_stat_m_span_sys", runtimeMetrics.MemStats.MSpanSys)
	r.Register("go.runtime mem_stat_next_gc", runtimeMetrics.MemStats.NextGC)
	r.Register("go.runtime mem_stat_num_gc", runtimeMetrics.MemStats.NumGC)
	r.Register("go.runtime mem_stat_gc_cpu_fraction", runtimeMetrics.MemStats.GCCPUFraction)
	r.Register("go.runtime mem_stat_pause_ns", runtimeMetrics.MemStats.PauseNs)
	r.Register("go.runtime mem_stat_pause_total_ns", runtimeMetrics.MemStats.PauseTotalNs)
	r.Register("go.runtime mem_stat_stack_inuse", runtimeMetrics.MemStats.StackInuse)
	r.Register("go.runtime mem_stat_stack_sys", runtimeMetrics.MemStats.StackSys)
	r.Register("go.runtime mem_stat_sys", runtimeMetrics.MemStats.Sys)
	r.Register("go.runtime mem_stat_total_alloc", runtimeMetrics.MemStats.TotalAlloc)
	r.Register("go.runtime num_cgo_call", runtimeMetrics.NumCgoCall)
	r.Register("go.runtime num_goroutine", runtimeMetrics.NumGoroutine)
	r.Register("go.runtime num_thread", runtimeMetrics.NumThread)
	r.Register("go.runtime read_mem_stats", runtimeMetrics.ReadMemStats)
}
